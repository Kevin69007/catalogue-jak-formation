...
import apprendreADeleguer from "../../public/assets/img/v1/APPRENDRE A DELEGUER.png";
import arabe from "../../public/assets/img/v1/arabe.png";
import bodyLangage from "../../public/assets/img/v1/body langage.png";
import calculerLaPaieDeDepart from "../../public/assets/img/v1/Calculer la Paie de Depart (SDTC).png";
import calculerLeBulletinDePaie from "../../public/assets/img/v1/Calculer le Bulletin de Paie.png";
import calculerLesElementsPostPaie from "../../public/assets/img/v1/Calculer les Elements Post Paie.png";
import calculerUnBulletinDePaieAvecLesElementsVariables from "../../public/assets/img/v1/Calculer un Bulletin de Paie avec les Elements Variables.png";
import chinois from "../../public/assets/img/v1/Chinois.png";
import choisirLesBonsOutilsDAideALaDecision from "../../public/assets/img/v1/CHOISIR LES BONS OUTILS D’AIDE A LA DECISION.png";
import comprendreLesBasesDeLaGestionDeProjet from "../../public/assets/img/v1/COMPRENDRE LES BASES DE LA GESTION DE PROJET.png";
import creationCabinetInfirmierLiberal from "../../public/assets/img/v1/Creation d'un Cabinet Infirmier Liberal.png";
import demarrerEtBoosterVotreMicroEntreprise from "../../public/assets/img/v1/Demarrer et Booster votre Micro-Entreprise.png";
...
import gestionDesPerformancesDesEmployes from "../../public/assets/img/v1/GESTION DES PERFORMANCES DES EMPLOYES.png";
import identifierLeRoleDesIRP from "../../public/assets/img/v1/Identifier le Role des IRP et la Notion de Confidentialite.png";
import identifierLesAmenagementsDuTempsDeTravail from "../../public/assets/img/v1/Identifier les Amenagements du Temps de Travail.png";
import illustrator from "../../public/assets/img/v1/illustrator.png";
import indesign from "../../public/assets/img/v1/indesign.png";
import initiationAI from "../../public/assets/img/v1/INITIATION A L'INTELLIGENCE ARTIFICIELLE.png";
import initiationMetierSecretaireBureautique from "../../public/assets/img/v1/Initiation au Metier de Secretaire Bureautique.png";
import initiationMetierSecretaireMedicale from "../../public/assets/img/v1/Initiation au Metier de Secretaire Medicale.png";
...
import maitriserVotreCommunication from "../../public/assets/img/v1/MAITRISER VOTRE COMMUNICATION.png";
...
import prelevementALaSource from "../../public/assets/img/v1/Prelevement a la Source.png";
import profiterPleinementDuTeletravail from "../../public/assets/img/v1/PROFITER PLEINEMENT DU TELETRAVAIL.png";
...
import sePresenterEn10Minutes from "../../public/assets/img/v1/SE PRESENTER EN 10 MINUTES.png";
import stimulerEtRecompenserSesEmployes from "../../public/assets/img/v1/STIMULER ET RECOMPENSER SES EMPLOYES.png";
import utiliserSaVoix from "../../public/assets/img/v1/utiliser sa voix.png";
import word from "../../public/assets/img/v1/Word.png";

import AbordsVasculairesEtSoinsInfirmiersADomicile from "../../public/assets/img/v1/Abords Vasculaires & Soins Infirmiers a Domicile.png";
import AlzheimerEtPriseEnChargeInfirmiere from "../../public/assets/img/v1/Alzheimer et Prise en Charge Infirmiere.png";
...
import BilanDeMedicationDeLaTheorieALaPratique from "../../public/assets/img/v1/Bilan de Medication De la Theorie a la Pratique.png";
import CalculerLeBulletinDePaie from "../../public/assets/img/v1/Calculer le Bulletin de Paie.png";
import COMBLEZLEPAGGENERATIONNEL from "../../public/assets/img/v1/COMBLEZ LE GAP GENERATIONNEL.png";
import CONQUERIRTOUSLESPUBLICS from "../../public/assets/img/v1/CONQUERIR TOUS LES PUBLICS.png";
import CONSTRUIRESONPERSONALBRANDING from "../../public/assets/img/v1/CONSTRUIRE SON PERSONAL BRANDING.png";
import CreerDesSitesInteractifsAvecReactEtRedux from "../../public/assets/img/v1/Creer des Sites Interactifs avec React et Redux.png";
import DECOUVRIRLAPNL from "../../public/assets/img/v1/DECOUVRIR LA PNL.png";
import DevenirUnDeveloppeurCSharp from "../../public/assets/img/v1/Csharp.png";
import DynamisezVosPresentationsCommerciales from "../../public/assets/img/v1/Dynamisez vos Presentations Commerciales.png";
import FacebookAdsDeDebutantAExpertVersion2022 from "../../public/assets/img/v1/Facebook Ads De Debutant a Expert Version 2022.png";
...
import GestionDeLUrgenceALOfficine from "../../public/assets/img/v1/Gestion de l'Urgence a l'Officine.png";
import GestionDesReseauxSociauxDeDebutantAExpert2022 from "../../public/assets/img/v1/Gestion des Reseaux Sociaux de Debutant a Expert 2022.png";
import HTML5EtCSS3DeDebutantAExpert from "../../public/assets/img/v1/HTML5 et CSS3 de Debutant a Expert.png";
import INTELLIGENCEEMOTIONNELLE from "../../public/assets/img/v1/INTELLIGENCE EMOTIONNELLE.png";
import JavaScriptLesFondamentaux from "../../public/assets/img/v1/JavaScript - Les Fondamentaux.png";
import LECOUTEACTIVE from "../../public/assets/img/v1/L’ECOUTE ACTIVE.png";
import LaCybersecuriteEnEntreprise from "../../public/assets/img/v1/La Cybersecurite en Entreprise.png";
import LaMethodeHACCP from "../../public/assets/img/v1/La Methode HACCP.png";
import LaPriseEnChargeInfirmiereDeLaDouleur from "../../public/assets/img/v1/La Prise en Charge Infirmiere de la Douleur.png";
...
import MAITRISERLAPENSEECRITIQUE from "../../public/assets/img/v1/MAITRISER LA PENSEE CRITIQUE.png";
import MAITRISERLESRELATIONSPUBLIQUES from "../../public/assets/img/v1/MAITRISER LES RELATIONS PUBLIQUES.png";
import OralBlancGestionnaireDePaie from "../../public/assets/img/v1/Oral Blanc - Gestionnaire de Paie.png";
import PARLERENPUBLICGERERLAPRESSION from "../../public/assets/img/v1/PARLER EN PUBLIC - GERER LA PRESSION.png";
import PrevoyanceEtPriseEnChargeInfirmiereDuRisqueSuicidaire from "../../public/assets/img/v1/Prevention et Prise en Charge Infirmiere du Risque Suicidaire.png";
import PriseEnChargeDesPlaiesEtCicatrisation from "../../public/assets/img/v1/Prise en Charge des Plaies et Cicatrisation.png";
import REUSSIRSONENTRETIEN from "../../public/assets/img/v1/REUSSIR SON ENTRETIEN.png";
import REUSSIRVOSPRESENTATIONSPOURCONVAINCRE from "../../public/assets/img/v1/REUSSIR VOS PRESENTATIONS POUR CONVAINCRE.png";
import REUSSIRVOTREPRESENTATIONVIRTUELLE from "../../public/assets/img/v1/REUSSIR VOTRE PRESENTATION VIRTUELLE.png";
...
import BilansEtRedFlags from "../../public/assets/img/v1/Bilans et Red-Flags en Kine Respiratoire Ambulatoire.png";
import KinesitherapieRehabilitationRespiratoire from "../../public/assets/img/v1/Kinesitherapie en Rehabilitation Respiratoire.png";
import LeveeDesTensionsMusculaires from "../../public/assets/img/v1/Levee des Tensions Musculaires.png";
...
import PriseEnChargeEpaule from "../../public/assets/img/v1/Prise en Charge des Pathologies de l'Epaule.png";
import PriseEnChargeGenou from "../../public/assets/img/v1/Prise en Charge des Pathologies du Genou.png";
import ReeducationPathologiesCheville from "../../public/assets/img/v1/Reeducation des Pathologies Traumatiques de la Cheville.png";
import ReeducationPelviPerinealeFeminine from "../../public/assets/img/v1/Reeducation Pelvi-Perineale Feminine Les Bases.png";
import RenforcementAbdominalPerinee from "../../public/assets/img/v1/Renforcement Abdominal et Sante du Perinee.png";
import allemant from "../../public/assets/img/v1/allemant.jpg";
import creationentreprise from "../../public/assets/img/v1/creationentreprise.jpg";
